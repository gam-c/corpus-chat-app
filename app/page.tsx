...
import botPic from "../public/bitImg.png";
  ...
  return (
    <div className="bg-slate-100 border-2 p-2 rounded-lg flex justify-center">
      ...
      {disabled && (
        <svg
          aria-hidden="true"
          className="mt-1 w-8 h-8 mr-2 text-gray-200 animate-spin fill-green-700"
          viewBox="0 0 100 101"
          fill="none"
